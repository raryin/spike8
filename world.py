...
class World(object):
    def __init__(self, cx, cy):
        self.cx = cx
        self.cy = cy
        self.spot1 = Vector2D(100,100)
        self.spot2 = Vector2D(150,380)
        self.spot3 = Vector2D(350,200)
        self.spot4 = Vector2D(900,100)
        self.target = Vector2D(cx / 2, cy / 2)
        self.hunter = None
        self.agents = []
        self.obstacles = []
        self.bestHidingSpot = None
        self.hidingSpots = [Vector2D(),Vector2D(),Vector2D()]
        self.paused = True
        self.show_info = True

        self.botMaxSpeed = 20.0 * 5.0 #5.0 = scale
